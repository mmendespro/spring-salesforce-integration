    ...
    public static class Result {
        ...
        public Map<String, Object> getSuccessResultsMap() {
            ...
            if (!(getHttpStatusCode() == 200 || getHttpStatusCode() == 201)) {
                throw new IllegalArgumentException(String.format("Result HttpStatusCode %s is not 200 or 201, call getErrorResultsList?", getHttpStatusCode()));
            }
        ...
        public List<Map<String, Object>> getErrorResultsList() {
            if (getHttpStatusCode() == 200 || getHttpStatusCode() == 201) {
                throw new IllegalArgumentException(String.format("Result HttpStatusCode %s indicates success, call getSuccessResultsMap?", getHttpStatusCode()));
            }
