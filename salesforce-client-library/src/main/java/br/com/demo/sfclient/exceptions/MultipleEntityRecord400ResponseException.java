package br.com.demo.sfclient.exceptions;

import java.util.List;

/**
 * Exception returned when some insertions had problems.  
 * In case of any error, none of the other insertions will go through, so recovery process may involve:
