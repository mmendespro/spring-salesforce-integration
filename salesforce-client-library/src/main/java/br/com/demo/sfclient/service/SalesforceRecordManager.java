...
import br.com.demo.sfclient.model.auth.SalesforceLoginResult;
import br.com.demo.sfclient.model.composite.RecordCreateResponse;
...
public class SalesforceRecordManager extends AbstractRESTService {
    ...
    public SalesforceRecordManager(WebClient webClient, ObjectMapper objectMapper, SalesforceAuthService salesforceAuthService) {
    ...
    public void update(String entity, String salesforceId, Object object) throws JsonProcessingException {
        ...
        log.info("Update record {} with Id {} and payload {}", entity, salesforceId, object);
        ...
        webClient
                .patch()
                .uri(sfAuthResult.getInstanceUrl() + "/services/data/" + API_VERSION + "/sobjects/" + entity + "/" + salesforceId)
    ...
    public RecordCreateResponse create(String entity, Object object) throws JsonProcessingException {
        ...
        log.info("Create record {} with {}", entity, object);
        ...
        return webClient
                .post()
                .uri(sfAuthResult.getInstanceUrl() + "/services/data/" + API_VERSION + "/sobjects/" + entity)
                .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                .headers(h -> h.setBearerAuth(sfAuthResult.getAccessToken()))
    ...
    public void deleteObject(String entity, String salesforceId) {
        log.info("Delete entity {} record with Id {}", entity, salesforceId);
    ...
    public String getJson(String entity, String salesforceId) {
        log.info("Obtain all information about {} entity with Id {}", entity, salesforceId);
